...
public class TransfersApiTests : IntegrationTestBase<Bucket2Factory>, IAsyncLifetime
{
    ...
    public TransfersApiTests(Bucket2Factory factory, Bucket2Database bucketDb) : base(factory, bucketDb)
    {
        _factory = factory;
