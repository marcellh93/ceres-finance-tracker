...
public class EmailChangeCrossFeatureTests : IntegrationTestBase<Bucket4AuthFactory>
{
    private readonly Bucket4AuthFactory _factory;

    public EmailChangeCrossFeatureTests(Bucket4AuthFactory factory, Bucket4Database bucketDb) : base(factory, bucketDb) => _factory = factory;
    ...
    private static async Task<HttpResponseMessage> PostConfirmAsync(
        WebApplicationFactory<Program> factory, Bucket4AuthFactory baseFactory, string token)
    {
