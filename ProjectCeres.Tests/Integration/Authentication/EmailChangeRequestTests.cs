...
public class EmailChangeRequestTests : IntegrationTestBase<Bucket2AuthFactory>
{
    private readonly Bucket2AuthFactory _factory;

    public EmailChangeRequestTests(Bucket2AuthFactory factory, Bucket2Database bucketDb) : base(factory, bucketDb) => _factory = factory;
