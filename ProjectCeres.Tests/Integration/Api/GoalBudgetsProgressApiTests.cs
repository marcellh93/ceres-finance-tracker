...
public class GoalBudgetsProgressApiTests : IntegrationTestBase<Bucket4Factory>, IAsyncLifetime
{
    ...
    public GoalBudgetsProgressApiTests(Bucket4Factory factory, Bucket4Database bucketDb) : base(factory, bucketDb)
    {
        _factory = factory;
