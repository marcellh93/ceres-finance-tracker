...
public class TransactionsCrudApiTests : IntegrationTestBase<Bucket2Factory>, IAsyncLifetime
{
    ...
    public TransactionsCrudApiTests(Bucket2Factory factory, Bucket2Database bucketDb) : base(factory, bucketDb)
    {
        _factory = factory;
