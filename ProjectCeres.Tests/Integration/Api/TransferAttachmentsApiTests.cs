...
public class TransferAttachmentsApiTests : IntegrationTestBase<Bucket2Factory>, IAsyncLifetime
{
    ...
    public TransferAttachmentsApiTests(Bucket2Factory factory, Bucket2Database bucketDb) : base(factory, bucketDb)
    {
        _factory = factory;
