...
public class BudgetsDiscriminatorApiTests : IntegrationTestBase<Bucket2Factory>, IAsyncLifetime
{
    ...
    public BudgetsDiscriminatorApiTests(Bucket2Factory factory, Bucket2Database bucketDb) : base(factory, bucketDb)
    {
        _factory = factory;
