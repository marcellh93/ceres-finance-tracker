...
public class SupportConversationApiTests : IntegrationTestBase<Bucket3Factory>, IAsyncLifetime
{
    ...
    public SupportConversationApiTests(Bucket3Factory factory, Bucket3Database bucketDb) : base(factory, bucketDb)
    {
        _factory = factory;
