...
public class TransfersCrudApiTests : IntegrationTestBase<Bucket2Factory>, IAsyncLifetime
{
    ...
    public TransfersCrudApiTests(Bucket2Factory factory, Bucket2Database bucketDb) : base(factory, bucketDb)
    {
        _factory = factory;
