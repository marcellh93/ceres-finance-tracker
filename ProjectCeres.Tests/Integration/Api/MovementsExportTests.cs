...
public class MovementsExportTests : IntegrationTestBase<Bucket3Factory>, IAsyncLifetime
{
    ...
    public MovementsExportTests(Bucket3Factory factory, Bucket3Database bucketDb) : base(factory, bucketDb)
    {
        _factory = factory;
