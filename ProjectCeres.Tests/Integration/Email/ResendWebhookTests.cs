...
public sealed class ResendWebhookTests : IntegrationTestBase<Bucket2AuthFactory>
{
    ...
    public ResendWebhookTests(Bucket2AuthFactory factory, Bucket2Database bucketDb) : base(factory, bucketDb) => _factory = factory;
