...
- `.claude/skills/playbook/references/constitution.md` — the eight-phase routing matrix, HARD vs advisory gates, Trip-wire C (the Stop-hook cap; the constitution does NOT define Trip-wire A/B — A is in the 9.5e spec §5.4, B + the autonomy ladder were retired in 9.5e)
