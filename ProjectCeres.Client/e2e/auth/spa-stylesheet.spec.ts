...
// served via wwwroot/dist/app.html (the Vite-built host) via MapFallbackToFile.
// The stylesheet was previously missing from the old Razor host (Views/App/Index.cshtml),
// causing the whole SPA to ship unstyled in production — invisible in dev, where the
// Vite dev server injects CSS via JS.
